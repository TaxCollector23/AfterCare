...
// read it, so accepting it here only moved the failure to after the upload,
// where it surfaced as "Unsupported file type" from the server. iOS Safari
// hands over a JPEG for both camera capture and photo-library picks.
