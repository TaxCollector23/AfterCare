...
import { ok, fail, type Medication, type OcrResult, type StageResult } from '@discharge/shared-types';
...
export async function detectMedications(
  ...
  try {
    ...
    return fail(err instanceof Error ? err.message : 'Medication detection failed');
  }
}
