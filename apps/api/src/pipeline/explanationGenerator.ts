...
export async function generateExplanations(ocr: OcrResult): Promise<StageResult<Explanation[]>> {
  try {
    ...
    return fail(err instanceof Error ? err.message : 'Explanation generation failed');
  }
}
